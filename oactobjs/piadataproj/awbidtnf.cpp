...
//
// $Id: awbidtnf.cpp 1.50 2017/11/28 08:20:25EST 277133 Development  $
...
// <summary>Benefit increases, 1951-2017.</summary>
const double AwbiDataNonFile::cpiincData[] = {
  ...
  11.2,  7.4,  3.5,  3.5,  3.1,  1.3,  4.2,  4.0,  4.7,  5.4,
   ...
   3.6,  1.7,  1.5,  1.7,  0.0,  0.3,  2.0
};

// <summary>Average wage index, 1937-2016.</summary>
...
// <summary>OASDI taxable maximum, 1937-2018.</summary>
const double AwbiDataNonFile::baseOasdiData[] = {
 ...
 118500.00, 127200.00, 128400.00
};

// <summary>HI taxable maximum, 1991-2018.</summary>
...
// <summary>Old-law taxable maximum, 1937-2018.</summary>
